...
export async function editProduct(req, res) {
    try {
        const { productId, name, description, price, isOnSale, salePrice, isOutOfStock, } = req.body;
        const product = await Product.findById(productId);
        if (!product) {
            return res.status(404).json({ message: "User or product not found" });
        }
...
export async function getMostRatedProducts(req, res) {
    try {
...
export async function editProductName(req, res) {
    try {
...
export async function editProductDescription(req, res) {
    try {
...
export async function editProductPrice(req, res) {
    try {
